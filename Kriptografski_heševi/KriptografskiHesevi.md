...
<div align="center">
  ...
  - **`ipad`**: *inner padding* или унутрашња попуна је хексадекадна константа дужине једног блока.
    - Ова константа садржи вредност хекс 0x36, која се понавља онолико пута колика је дужина блока хеш фунцкије у бајтовима.
    - Пример: hashBlock = 0xABC123 -> то је дужина од 3B, значи за овакву хеш фунцкију потребно је да имам ipad дужине 3 бајта, ipad=0x363636
