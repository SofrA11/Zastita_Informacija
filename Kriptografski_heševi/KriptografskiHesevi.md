...
<div align="center">
  ...
  - **`ipad`**: *inner padding* или унутрашња попуна је хексадекадна константа дужине једног блока.
    ...
    - **Пример**:
      **`hashBlock = 0xABC123`** -> то је дужина од **3B**, значи за овакву хеш фунцкију потребно је да **ipad** буде дужине 3 бајта, **`ipad=0x363636`**.
  - **`opad`**: *outer padding* или спољашња попуна је хексадекадна константа дужине једног блока.
    ...
    - **Пример**:
       **`hashBlock = 0xABC123`** -> то је дужина од **3B**, значи за овакву хеш фунцкију потребно је да **opad** буде дужине 3 бајта, **`opad=0x5C5C5C`**.
